...
public class AdaptiveTrackSelection extends BaseTrackSelection {
  ...
  public void updateSelectedTrack(long bufferedDurationUs) {
    Log.d("PlayerActivity","updateSelectedTrack");
    ...
    if(ContextInformation.responseQuality != 0){
      switch(ContextInformation.responseQuality){
        case (240) :
          selectedIndex = 4;
          break;
        ...
        default :
          Log.e("Error","Non-Defined Quality!");
          break;
      }
    }
