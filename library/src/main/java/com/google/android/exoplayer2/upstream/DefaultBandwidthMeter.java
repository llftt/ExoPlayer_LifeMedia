...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener<Object> {
  ...
  private long bitrateJitterEstimate;
  private long previousBitrate = 0;
  ...
  public DefaultBandwidthMeter(Handler eventHandler, EventListener eventListener, int maxWeight) {
    ...
    bitrateJitterEstimate = NO_ESTIMATE;
  }
  ...
  @Override
  public synchronized long getBitrateJitterEstimate() {
    return bitrateJitterEstimate;
  }
  ...
  public synchronized void onTransferEnd(Object source) {
    ...
    if (sampleElapsedTimeMs > 0) {
      ...
      if (totalElapsedTimeMs >= ELAPSED_MILLIS_FOR_ESTIMATE
        ...
        bitrateJitterEstimate = bitrateEstimate - previousBitrate;
        previousBitrate = bitrateEstimate;
      }
    }
